...
# ======================
# Contoh CSV & GeoJSON
# ganti path sesuai filemu
df_scores = pd.read_csv("data/scores.csv")       # skor pilar
gdf_kab = gpd.read_file("data/geojson_kabupaten.geojson")  # GeoJSON kabupaten
...
st_data = st_folium(m, width="stretch")
...
fig = px.bar(df_scores, x="kabupaten", y=["pilar_1","pilar_2","pilar_3"],
             title="Perbandingan Pilar IDSD per Kabupaten", barmode="group")
